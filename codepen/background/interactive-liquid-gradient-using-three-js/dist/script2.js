...
class GradientBackground {
  constructor(sceneManager) {
    ...
    this.uniforms = {
      ...
      uColor1: { value: new THREE.Vector3(0.945, 0.353, 0.533) }, // F15A22 - Orange
      ...
      uColor5: { value: new THREE.Vector3(0.945, 0.353, 0.633) }, // F15A22 - Orange
      uColor6: { value: new THREE.Vector3(0.039, 0.055, 0.153) }, //0a0e27 Navy Blue
      uSpeed: { value: 2.2 }, // Faster animation
...
class App {
  constructor() {
    ...
    this.colorSchemes = {
      1: {
        // Orange + Navy Blue
        color1: new THREE.Vector3(0.395, 0.395, 0.595), // F15A22 - Orange
      ...
      3: {
        //Orange +Navy +Turquoise (identical to scheme 1 but w turquoise added)
        color1: new THREE.Vector3(0.945, 0.353, 0.133), // F15A22 Orange
        color2: new THREE.Vector3(0.039, 0.055, 0.153), // 0a0e27 Navy Blue
        color3: new THREE.Vector3(0.251, 0.878, 0.816) // 40E0D0 Turquoise
      },
      4: {
        // 0.0-1.0): (0.157, 0.373, 0.957) (approximate) Based on Scheme 3: F26633 + 2D6B6D + D1AF9C
        color1: new THREE.Vector3(0.82, 0.686, 0.612), // F26633 - Orange/Coral
        color2: new THREE.Vector3(0.157, 0.373, 0.957), //2D6B6D Teal/Blue-Green
        color3: new THREE.Vector3(0.12, 0.12, 0.12) // D1AF9C - Beige/Peach
      },
      5: {
        // F15A22 + 004238 + F15A22 + 000000 + F15A22 + 000000
        color1: new THREE.Vector3(0.945, 0.353, 0.533), // F15A22 - Orange
        color2: new THREE.Vector3(0.0, 0.259, 0.22), //004238 DarkTeal (0,66,56)Vector3(0.12, 0.12, 0.12)
        color3: new THREE.Vector3(0.12, 0.12, 0.12), // F15A22 - Orange
        color4: new THREE.Vector3(0.0, 0.0, 0.0), // 000000 - Black
        color5: new THREE.Vector3(0.443, 0.478, 0.976), // F15A22 - OrangeVector3.new(0.443, 0.478, 0.976)
  ...
  setColorScheme(scheme) {
    ...
    if (scheme === 1) {
      ...
      uniforms.uSpeed.value = 0.5; // Slightly faster for more movement
      ...
      uniforms.uGradientSize.value = 0.45; // Smaller gradient radius for more defined gradients
      uniforms.uGradientCount.value = 12.0; // More gradient centers (12 instead of 6)
      uniforms.uSpeed.value = 0.45; // Slightly faster for more movement
      // Balance colors: reduce orange, increase navy
      uniforms.uColor1Weight.value = 0.5; // Reduce orange intensity
      uniforms.uColor2Weight.value = 1.8; // Increase navy intensity
    } else if (scheme === 5) {
      ...
      uniforms.uSpeed.value = 0.2; // Default speed
