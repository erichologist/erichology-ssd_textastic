/*! @license DOMPurify 2.4.7 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.4.7/LICENSE */ ! function(e, t) {
    ...
    var Q = function t() {
        ...
        var he, ge, ye = G,
            ...
            we = K,
            Se = null,
            _e = L({}, [].concat(r(M), r(R), r(C), r(F), r(H))),
            xe = null,
            ke = L({}, [].concat(r(z), r(P), r(j), r(B))),
                    ...
                    for (i = l.length; i--;) {
                        ...
                        if (r = "value" === u ? n.value : S(n.value), a = ge(u), c.attrName = a, c.attrValue = r, c.keepAttr = !0, c.forceKeepAttr = void 0, Et("uponSanitizeAttribute", t, c), r = c.attrValue, !c.forceKeepAttr && (bt(u, t), c.keepAttr))
                            if (Ie || !_(/\/>/i, r)) {
                                ...
                                var f = ge(t.nodeName);
                                if (wt(f, a, r)) {
                                    if (!We || "id" !== a && "name" !== a || (bt(u, t), r = "user-content-" + r), ae && "object" === e(k) && "function" == typeof k.getAttributeType)
                                        if (m);
                                        else switch (k.getAttributeType(f, a)) {
                                            case "TrustedHTML":
                                                r = ae.createHTML(r);
                                                break;
        ...
        return o.sanitize = function(t) {
            ...
            if (He || mt(f), o.removed = [], "string" == typeof t && (Ye = !1), Ye) {
                if (t.nodeName) {
                    var p = ge(t.nodeName);
                    if (!Se[p] || Oe[p]) throw x("root node is forbidden and cannot be sanitized in-place")
                }
            ...
            for (var d = Tt(Ye ? t : r); c = d.nextNode();) 3 === c.nodeType && c === u || At(c) || (c.content instanceof l && xt(c.content), _t(c), u = c);
...
//https://loading.io/assets/lib/dompurify/main/dist/purify.min.js?dec=922dfbf9
