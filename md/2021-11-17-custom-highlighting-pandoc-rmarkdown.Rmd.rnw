...
```language-markdown {r setup, include = FALSE}
...
```language-markdown {r install, eval = FALSE}
...
```language-markdown {r, eval = FALSE}
rmarkdown::render(
  "README.Rmd", 
...
```language-pandoc {r, comment = "", echo = FALSE}
...
```language-markdown {r, results = 'hide'}
...
```language-md {r, comment = "", echo = FALSE}
...
```language-pandoc {r shot1, fig.cap = "Screenshot of html file created by pandoc"}
...
```language-pandoc {r shot2, fig.cap = "Screenshot of html file created by pandoc. It now has solarized colors."}
...
```language-pandoc {r shot3, fig.cap = "Screenshot of html file created by pandoc. It now has solarized colors and differently styled #> comments."}
...
```language-markdown {r shot4, fig.cap = "Screenshot of html file created by pandoc. It has a purple background, white text, gold comments and yellow strings, but it still looks bad because not all of the colors are done."}
...
```language-markdown {r shot5, fig.cap = "Screenshot of html file created by pandoc. It now has Fairy Floss colors."}
...
```language-markdown {r shot6, fig.cap = "Screenshot of html file created by RMarkdown. It has the default colors."}
...
```language-markdown {r shot7, fig.cap = "Screenshot of html file created by RMarkdown. It has the Fairy Floss colors."}
out <- rmarkdown::render(
  md_file, 
...
```language-markdown {r shot8, fig.cap = "Screenshot of a cropped pdf file created by RMarkdown. It has the Fairy Floss colors."}
out <- rmarkdown::render(
  md_file, 
...
```language-markdown {r, include = FALSE}
.parent_doc <- knitr::current_input()
```
```language-markdown {r, child = "_R/_footer.Rmd"}
```
