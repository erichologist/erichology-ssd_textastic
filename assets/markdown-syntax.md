...
xhtml header:		<script type="text/javascript" src="http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML">
	...
	<script type="text/javascript" src="./prism.js"></script></script>
	<style>/*:not(pre)*/code,blockquote{-ms-word-wrap:break-word; word-wrap:break-word; white-space:pre-line !important; max-width:360px !important; -ms-word-break:break-all !important; word-break:break-all !important; }pre:has(>code){margin-bottom:4% !important; }</style>
